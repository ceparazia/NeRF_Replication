...
# module
cfg.train_dataset_module = "src.datasets.dtu.neus"
cfg.test_dataset_module = "src.datasets.dtu.neus"
cfg.val_dataset_module = "src.datasets.dtu.neus"
cfg.network_module = "src.models.neus.neus"
cfg.loss_module = "src.train.losses.neus"
cfg.evaluator_module = "src.evaluators.neus"
...
cfg.task_arg = CN()
cfg.task_arg.sample_more_on_mask = -1.0
